...
- Two files become three at runtime (`prime_module.js`, `prime_module.wasm`,
  `prime_module.worker.js` generated by Emscripten).
...
├── prime_module.worker.js  ← generated pthread Worker bootstrap
├── index.html
├── prime_service.js
└── server.py
```
